    ...
    void Update()
    {
        ...
        if (Input.GetMouseButton (0)) {
            if (Input.GetKey (KeyCode.J)) {
                // untuk kode roll kekanan
                transform.rotation = transform.rotation * toQuaternion (mundur * speedRotasi * Time.deltaTime);
            }

            if (Input.GetKey (KeyCode.G)) {
                // untuk kode roll kekiri
                transform.rotation = transform.rotation * toQuaternion (maju * speedRotasi * Time.deltaTime);
            }

            if (Input.GetKey (KeyCode.Y)) {
                // untuk kode pitch keatas
                transform.rotation = transform.rotation * toQuaternion (kekanan * speedRotasi * Time.deltaTime);
            }

            if (Input.GetKey (KeyCode.H)) {
                // untuk kode pitch kebawah
                transform.rotation = transform.rotation * toQuaternion (kekiri * speedRotasi * Time.deltaTime);
            }

            if (Input.GetKey (KeyCode.T)) {
                // untuk kode yaw kekiri
                transform.rotation = transform.rotation * toQuaternion (keatas * speedRotasi * Time.deltaTime);
            }

            if (Input.GetKey (KeyCode.U)) {
                // untuk kode yaw kekanan
                transform.rotation = transform.rotation * toQuaternion (kebawah * speedRotasi * Time.deltaTime);
            }
        } else {}
    }
